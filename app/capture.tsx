...
export default function CaptureScreen() {
    ...
    const [targetPosition, setTargetPosition] = useState<CapturePosition | null>(null);
    ...
    useEffect(() => {
        if (state.currentProject) {
            ...
            if (next && prevRowRef.current !== null && next.row !== prevRowRef.current) {
    ...
    const handleCapture = useCallback(async () => {
        ...
        try {
            ...
            if (photo) {
                ...
                // Count animation
                photoCountAnim.value = withSequence(
                    withSpring(1.3),
                    withSpring(1)
                );
            }
            ...
            <View style={styles.permissionContainer}>
                ...
                >
                    ...
                    <Text style={styles.permissionText}>
                        Pour capturer votre panorama 360°, nous avons besoin d'accéder à votre caméra.
                    </Text>
    ...
    const totalCount = state.currentProject?.totalPhotos || CAPTURE_CONFIG.TOTAL_PHOTOS;
    const progressPercent = totalCount > 0 ? (capturedCount / totalCount) * 100 : 0;
    ...
    return (
        <View style={styles.container}>
            ...
            {/* Success check */}
            <Animated.View style={[styles.successIndicator, successStyle]} pointerEvents="none">
            ...
            {/* Row transition message */}
            {rowMessage && (
                <Animated.View style={[styles.rowTransition, rowMessageStyle]} pointerEvents="none">
                    <View style={[styles.rowTransitionInner, { borderColor: rowColor + '50' }]}>
                        <View style={[styles.rowTransitionIconWrap, { backgroundColor: rowColor + '20' }]}>
                            <MaterialIcons
                                name={CAPTURE_CONFIG.ROW_ICONS[currentRow] as keyof typeof MaterialIcons.glyphMap}
                                size={32}
                                color={rowColor}
                            />
                        </View>
            ...
            <View style={styles.bottomSection}>
                ...
                <View style={styles.captureRow}>
                    ...
                    <Animated.View style={[styles.countContainer, photoCountAnimStyle]}>
                        <Text style={[styles.countNumber, { color: rowColor }]}>{capturedCount}</Text>
                    ...
                    >
                        <Animated.View style={captureButtonAnimStyle}>
                            ...
                            >
                                ...
                                >
                                    {isTakingPhoto && (
                                        <MaterialIcons name="hourglass-top" size={24} color="rgba(255,255,255,0.5)" />
                                    )}
                                </View>
                            </View>
                        </Animated.View>
                            ...
                            <View style={styles.modalSteps}>
                                <View style={styles.modalStep}>
                                    ...
                                    <Text style={styles.stepText}>
                                        Tournez sur vous-même ({CAPTURE_CONFIG.COLS_PER_ROW[0]} photos)
                                    </Text>
                                </View>
                                <View style={styles.modalStep}>
                                    ...
                                    <Text style={styles.stepText}>
                                        Inclinez vers le haut ({CAPTURE_CONFIG.COLS_PER_ROW[1]} photos)
                                    </Text>
                                </View>
                                <View style={styles.modalStep}>
                                    ...
                                    <Text style={styles.stepText}>
                                        Inclinez vers le bas ({CAPTURE_CONFIG.COLS_PER_ROW[2]} photos)
                                    </Text>
                                </View>
                                <View style={styles.modalStep}>
